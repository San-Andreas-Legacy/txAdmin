...
import { ClipboardCheckIcon, ClipboardListIcon, DoorOpenIcon, ListIcon, PieChartIcon, ScrollIcon, SettingsIcon, UserSquare2Icon, UsersIcon, ZapIcon } from 'lucide-react';
                    ...
                    <div className="mb-4">
                        ...
                        <div className="flex flex-wrap flex-row xs:grid grid-cols-2 gap-4">
                            ...
                            <MenuNavLink href="/reports">
                                <ClipboardListIcon className="mr-2 h-4 w-4" />Reports
                            </MenuNavLink>
